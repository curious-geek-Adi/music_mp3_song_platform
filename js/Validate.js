...
function validate1(){
    ...
    if(fname==''){
        tdNode1.text("* please put your First name");
...
function validate3(){
    ...
    if(uname==''){
        tdNode3.text("* please put your User name");
        unameNode.css('border',border1);
        return false;
    }
    else if(uname.length<3 || uname.length >10){
        tdNode3.text("user name must have atleast 3 and at most 10 chars");
        unameNode.css('border',border1);
        return false;
    }
    else{
...
function validate4(){
    ...
    if(password==''){
        ...
        spanNode.text("password should contain atleast one charachter");
        let ulNode=$('<ul>');
        let liNode1=$('<li>');
        let liNode2=$('<li>');
        let liNode3=$('<li>');
...
function validate5(){
    ...
    let password=passNode.val();
    if(confirmPass==''){
        tdNode5.text("* please check Your password");
...
function validate8(){
    ...
    else if(age<14 || age>110){
        tdNode8.text("please put valid age (14+ to 110)");
        ageNode.css('border',border1);
        return false;
    }
    else{
